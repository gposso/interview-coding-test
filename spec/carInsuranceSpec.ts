...
describe("CarInsurance", function () {
    ...
    describe("full coverage strategy", function () {
    ...
    describe("mega coverage strategy", function () {
    ...
    describe("special full coverage strategy", function () {
    ...
    describe("super sale strategy", function () {
    ...
    describe("medium coverage strategy", function () {
    ...
    describe("low coverage strategy", function () {
